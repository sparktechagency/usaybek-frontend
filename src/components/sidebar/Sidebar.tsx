    ...
    return (
        <>
            ...
            <div className="flex min-h-screen  bg-white">
                ...
                <div
                    className={clsx(
                        "h-screen px-4 py-6  left-0 bg-white shadow-lg z-40 transition-all duration-300 overflow-hidden overflow-y-auto",
                        open ? "w-72" : "w-20"
                    )}
                >
                    {/* Toggle Button */}
                    ...
                    <nav className="mt-10 space-y-6">
                        ...
                        {[
                            ...
                            <Link
                                key={idx}
                                href={link}
                                className="flex items-center gap-3 px-3 py-2.5 rounded-full hover:bg-gray-100 transition"
      ...
      {label}
                ...
                {/* Main Content */}
                <div className={clsx("flex-1 p-6 transition-all duration-300", open ? "ml-72" : "ml-20")}>
                    <h1>
